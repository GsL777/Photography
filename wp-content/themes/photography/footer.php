		...
		<div class="container text-center text-md-left">
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-lg-6 col-md-6 footer-style">
					<div class="socials">
						<a href="<?php echo $facebook; ?>" target="_blank" rel="nofollow"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>

						<a href="<?php echo $twitter; ?>" target="_blank" rel="nofollow"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>

						<a href="<?php echo $linkedin; ?>" target="_blank" rel="nofollow"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>

						<a href="<?php echo $instagram; ?>" target="_blank" rel="nofollow"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a>
					</div><!-- .socials -->
				</div><!-- .col-lg-6 -->
		    </div><!-- .row -->
		</div><!-- .container -->
